...
public class PlayerService {
    ...
    public void sendTNSM(Player player, byte type, long param) {
        if (param > 0) {
            ...
            try {
                ...
                msg.writeLongByHoandz(Util.maxIntValue((int) param), cn.readInt);// số tn cần cộng
    ...
    public void sendInfoHp(Player player) {
        ...
        try {
            ...
            msg.writeLongByHoandz(Util.maxIntValue(player.nPoint.hp), cn.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
           System.out.println("Lỗi send info hp");
        }
    }
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writeLongByHoandz(Util.maxIntValue(player.nPoint.mp), cn.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {

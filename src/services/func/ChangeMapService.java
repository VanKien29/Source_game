    ...
    private void sendEffectMeToMap(Player player) {
        ...
        try {
            ...
            if (player.mobMe != null) {
                ...
                msg.writeLongByHoandz(Util.maxIntValue(player.mobMe.point.gethp()), cn.readInt);// hp mob
                Service.gI().sendMessAnotherNotMeInMap(player, msg);
                msg.cleanup();
            }
            if (player.pet != null && player.pet.mobMe != null) {
                ...
                msg.writeLongByHoandz(Util.maxIntValue(player.pet.mobMe.point.gethp()), cn.readInt);// hp mob
                Service.gI().sendMessAnotherNotMeInMap(player, msg);
                msg.cleanup();
            }
        } catch (Exception e) {
            ...
            for (Player pl : players) {
                if (!player.equals(pl)) {
                    ...
                    if (pl.mobMe != null) {
                        ...
                        msg.writeLongByHoandz(Util.maxIntValue(pl.mobMe.point.gethp()), cn.readInt);// hp mob
                        player.sendMessage(msg);
                        msg.cleanup();
                    }
                }

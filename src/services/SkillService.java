...
public class SkillService {
    ...
    private void useNewSkillNotFocus(Player player, Player plTarget, Mob mobTarget, int status, byte skillId, Short dx,
        ...
        try {
            ...
            switch (skillId) {
                ...
                case Skill.SUPER_TRAI_DAT, Skill.SUPER_NAMEC, Skill.SUPER_SAIYAN -> {
    ...
    public void callPhanThan(Player player) {
        ...
        try {
            new PhanThan(player, bossDataClone, 60000);
        } catch (Exception e) {
        }
    }
...
//                }
        ...
        if (plAtt != null && plTarget != null && plTarget.nPoint != null) {
            ...
            if (percentPST != 0) {
                ...
                try {
                    ...
                    msg.writeLongByHoandz(Util.maxIntValue(plAtt.nPoint.hp), cn.readInt);
    ...
    private void playerAttackPlayer(Player plAtt, Player plInjure, boolean miss) {
        ...
        try {
            ...
            msg.writeLongByHoandz(Util.maxIntValue(dameHit), cn.readInt); // dame ăn

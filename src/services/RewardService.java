...
public class RewardService {
    ...
    private static final int[][][] ACTIVATION_SET = {
            { { 129, 141, 1, 5000 }, { 127, 139, 1, 1000 }, { 128, 140, 1, 1000 } }, // songoku - thien xin hang - kirin
            { { 131, 143, 1, 2500 }, { 132, 144, 1, 2500 }, { 130, 142, 1, 2500 } }, // oc tieu - pikkoro daimao -
                                                                                     // picolo
            { { 135, 138, 1, 2500 }, { 133, 136, 1, 1000 }, { 134, 137, 1, 5000 } } // kakarot - cadic - nappa
    };
    ...
    // ========================LUCKY ROUND========================
        ...
        for (int i = 0; i < num; i++) {
            Item it = ItemService.gI().createNewItem((short) 225); // vang
            it.quantity = Util.nextInt(5, 10) * 100;
            boolean success = Util.isTrue(1, 2);
            if (vip) {
                if (Util.isTrue(1, 10000)) {
                    it = ItemService.gI().createNewItem((short) Util.nextInt(2, 5));
                    it.quantity = 1;
                    ...
                    int[] itemId = {1204, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 859, 956 };
                ...
                if (Util.isTrue(1, 10)) {
                    int[] itemId = {828, 1204, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 859, 956};
                    int itemid = itemId[Util.nextInt(itemId.length)];
                    it = ItemService.gI().createNewItem((short) itemid);
                }

...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.nuocMiaKhongLo) {
            sendItemTime(player, 13462, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeKhongLo)) / 1000));
        }
        if (player.itemTime.nuocMiaThom) {
            sendItemTime(player, 13463, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeThom)) / 1000));
        }
        if (player.itemTime.nuocMiaSauRieng) {
            sendItemTime(player, 13464, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeSauRieng)) / 1000));
        }
        if (player.itemTime.isUsePhoTaiHanh) {
            sendItemTime(player, 16312, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimePhoTaiHanh)) / 1000));
        }
        if (player.itemTime.isUsePhoNam) {
            sendItemTime(player, 16314, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimePhoNam)) / 1000));
        }
        if (player.itemTime.isUsePhoTaiBo) {
            sendItemTime(player, 16313, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimePhoTaiBo)) / 1000));
        }
        ...
        if (player.itemTime.isXimuoihoadao) {
            sendItemTime(player, 10905,
                    (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeXimuoihoadao)) / 1000));
        }
        if (player.itemTime.isBanhtet) {
            sendItemTime(player, 7079,
                    (int) ((TIME_CMS - (System.currentTimeMillis() - player.itemTime.lastTimeBanhtet)) / 1000));
        }
        if (player.itemTime.isBanhchung) {
            sendItemTime(player, 7080,
                    (int) ((TIME_CMS - (System.currentTimeMillis() - player.itemTime.lastTimeBanhchung)) / 1000));
        }
        if (player.itemTime.isXimuoihoamai) {
            sendItemTime(player, 10904,
                    (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeXimuoihoamai)) / 1000));
        }

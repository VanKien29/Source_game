...
public class ThachDau extends PVP {
    ...
    public void sendResult(Player plLose, TYPE_LOSE_PVP typeLose) {
        if (typeLose == TYPE_LOSE_PVP.RUNS_AWAY) {
            ...
            if (plL == null) {
                Service.gI().sendThongBao(p1.equals(plLose) ? p2 : p1,
                        "Đối thủ rời game, bạn thắng được " + Util.numberToMoney(this.goldReward) + " vàng");
            } else {
                Service.gI().sendThongBao(p1.equals(plLose) ? p2 : p1,
                        "Đối thủ sợ quá bỏ chạy, bạn thắng được " + Util.numberToMoney(this.goldReward) + " vàng");
            }
            ...
            Service.gI().sendThongBao(p1.equals(plLose) ? p2 : p1,
                    "Đối thủ đã kiệt sức, bạn thắng được " + Util.numberToMoney(this.goldReward) + " vàng");

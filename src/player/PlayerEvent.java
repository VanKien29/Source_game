...
public class PlayerEvent {
    ...
    public int getEventPointLixi() {
        return eventPointLixi;
    }
    ...
    public void setEventPointLixi(int eventPointLixi) {
        this.eventPointLixi = eventPointLixi;
    }
    ...
    public void subEventPointLixi(int num) {
        eventPointLixi -= num;
    }
    ...
    public void addEventPointLixi(int num) {
        eventPointLixi += num;
    }

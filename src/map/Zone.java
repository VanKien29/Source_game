...
public class Zone {
    ...
    private void infoPlayer(Player plReceive, Player plInfo) {
        ...
        try {
            ...
            msg.writeLongByHoandz(Util.maxIntValue(plInfo.nPoint.hp), cn.readInt);
            msg.writeLongByHoandz(Util.maxIntValue(plInfo.nPoint.hpMax), cn.readInt);
        ...
        try {
            ...
            try {
                ...
                for (Mob mob : mobs) {
                    ...
                    //   msg.writer().writeBoolean(mob.tempId == ConstMob.MAY_DO_SUC_MANH);
                    ...
                    msg.writeLongByHoandz(Util.maxIntValue(mob.point.getHpFull()), cn.readInt);

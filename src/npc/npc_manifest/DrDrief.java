                                            ...
                                            if (player.playerTask.clanTask.isDone()) {
                                                createOtherMenu(player, ConstNpc.MENU_CLAN_TASK,
                                                        "Nhiệm vụ đã hoàn thành, hãy nhận "
                                                                + ((player.playerTask.clanTask.level + 1) * 10)
                                                                + " capsule bang",
                                                        "Nhận\nthưởng", "Đóng");
                                                break;
                                            }
                            ...
                            case 2 -> {
                                ...
                                if (clan != null) {
                                    ...
                                    if (clan.isLeader(player)) {
                                        ...
                                        String npcSay = "Cần " + Util.chiaNho(ClanService.gI().capsule(clan))
                                                + " capsule bang [đang có " + Util.chiaNho(clan.capsuleClan)
                            ...
                            if (clan.isLeader(player)) {
                                ...
                                if (capsuleBang >= capsuleCan) {
                                    ...
                                    Service.gI().sendThongBao(player, "Không đủ capsule bang, cần "
                                            + Util.chiaNho(capsuleCan - capsuleBang) + " capsule bang nữa.");
                                }
                            }
                        }
                    }

...
public class CoGaiSexy extends Npc {

    public CoGaiSexy(int mapId, int status, int cx, int cy, int tempId, int avartar) {
                ...
                switch (select) {
                    case 0 -> {
                        ...
                        if (utils.Util.isTrue(5, 100)) {
                            ...
                            caiTrang.addOptionParam(101, utils.Util.nextInt(10, 20));
                            caiTrang.addOptionParam(utils.Util.isTrue(5, 100) ? 117 : utils.Util.isTrue(5, 100) ? 14 : 5, utils.Util.nextInt(5, 8));
                            ...
                            thuCung.addOptionParam(101, utils.Util.nextInt(5, 10));
                            thuCung.addOptionParam(utils.Util.isTrue(5, 100) ? 117 : utils.Util.isTrue(5, 100) ? 14 : 5, utils.Util.nextInt(1, 3));
                            if (utils.Util.isTrue(100, 100)) {
                            ...
                            deoLung.addOptionParam(101, utils.Util.nextInt(5, 10));
                            if (utils.Util.isTrue(100, 100)) {
                            ...
                            vatPham.quantity = vatPham.template.id == 457 ? utils.Util.nextInt(20, 50) : 1;

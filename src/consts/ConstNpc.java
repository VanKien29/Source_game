...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "Các phần thưởng như sau\b1 sao đen: +5% sức đánh\b2 sao đen: +10% HP\b"
            + "3 sao đen: Biến 10% tấn công thành HP\b4 sao đen: Phản 10% sát thương\b"
            + "5 sao đen: 3% Sức đánh chí mạng\b6 sao đen: KI+10%\b7 sao đen: 5% Né đòn";
    ...
    public static final byte SO_SU_MENH = 76;
    public static final int CONFIRM_OPEN_VIP = 2001;
    public static final byte HOA_HONG = 104;
    public static final byte BULMA_THO = 109;
    public static final byte BUI_HOA_HONG = 79;
    public static final byte CO_GAI_SEXY = 80;
    public static final byte HOAN_SEC = 82;
    public static final byte REN_VANG = 83;
    public static final byte TONG_MON_SU = 81;
    public static final byte PHO_ANH_HOAN = 84;
    public static final byte CAU_VANG = 85;
    public static final byte RUONG_SUU_TAP = 86;
    public static final byte XE_MIA = 87;
    public static final byte TIEN_CAP = 88;
    ...
    public static final int MENU_REWARD = 9911;
    public static final int CONFIRM_BUY_LEVEL = 9912;
    // index quy lão kamê
    ...
    public static final int THONG_BAO_TRUNG_MABU = 600;
    public static final int THONG_BAO_DE_TYPE3 = 601;
    public static final int THONG_BAO_DE_TYPE5 = 602;
    public static final int THONG_BAO_DE_TYPE6 = 603;
    public static final int THONG_BAO_DE_TYPE7 = 604;
    public static final int MENU_DOI_HT_DE = 605;
    ...
    public static final int DOIXUOCEAN = 505;
    ...
    public static final int BINH_HUT_NANG_LUONG = 505;
    public static final int BUA_HO_TRO = 506;
    ...
    public static final int DOIXUKRAI = 5560;
    ...
    public static final int MENU_TX = 2008;
    ...
    public static final int SET_KHTD = 1303;
    public static final int SET_KHNM = 1304;
    public static final int SET_KHXD = 1305;
    public static final int MENU_OPTION_USE_ITEM1703 = 1703;
    public static final int MENU_OPTION_USE_ITEM1704 = 1704;
    public static final int MENU_OPTION_USE_ITEM1968 = 1968;
    public static final int MENU_OPTION_USE_ITEM1536 = 1536;

    public static final int ĐỔI_PHIẾU_BÉ_NGOAN = 22154236;
    public static final int MENU_TET_2025 = 22154237;
    public static final int MENU_NAU_BANH = 22154238;
    public static final int MENU_NAU_BANH_1 = 22154239;
    public static final int MENU_NAU_BANH_TU_CHOI_1 = 34677;
    public static final int MENU_NAU_BANH_2 = 22154240;
    public static final int MENU_NAU_BANH_TU_CHOI_2 = 34678;
    public static final int RECEIVE_KOL_TASK = 251014;
    public static final int MO_RONG_COLLECTION_BOX = 251013;
    public static final int MENU_1_LY = 251015;
    public static final int MENU_1_LY_2 = 251016;
    public static final int MENU_10_LY = 251017;
    public static final int MENU_10_LY_2 = 251018;
}

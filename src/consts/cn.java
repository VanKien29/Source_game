...
public class cn {
    ...
    public final static String SDT = "0395134812";
    ...
    public final static String MANAP = "cat ";
    ...
    public static int ghThoiVangThuong = 50000000;
    ...
    private static class ________________________NPC_TRUNGLINHTHU______________________ {//Name:
        // Hoandz
    ...
    private static class ________________________NPC_GOHAN_PAGUSU_NAMEC_____________________ {//Name:
        // Hoandz
    ...
    // giá đệ cao cấp (Beerus, Pic, Black)
    public static int de37 = 800000 * GIA_X; // Beerus
    public static int de38 = 900000 * GIA_X; // Pic
    public static int de39 = 1000000 * GIA_X; // Black
    ...
    public static short thoivangthuong = 1810;
    ...
    private static class ________________________Chỉ_số_hợp_thể_đệ______________________ {//Name:
        // Hoandz

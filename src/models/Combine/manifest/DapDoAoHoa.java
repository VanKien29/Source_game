        ...
        if (player.combine.itemsCombine.size() >= 2 && player.combine.itemsCombine.size() < 4) {
            ...
            if (itemDo != null) {
                ...
                if (!check1) {
                    CombineService.gI().baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần đồ đã pha lê hóa 5 sao trở lên", "Đóng");
                    return;
                }
                if (!check2) {
                    CombineService.gI().baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần đồ đã ép 5 sao pha lê trở lên", "Đóng");
                    return;
                }
            ...
            if (isCoupleItemNangCapCheck(itemDo, itemDNC)) {
                ...
                if (level < CombineService.MAX_LEVEL_ITEM) {
                    ...
                    if ((level == 2 || level == 4 || level == 6 || level == 8 || level == 9) && !(player.combine.itemsCombine.size() == 3 && itemDBV != null)) {
...
//   
                        ...
                        if ((level == 2 || level == 4 || level == 6 || level == 8 || level == 9) && (player.combine.itemsCombine.size() != 3)) {
                            if (option == null) {

...
public class CheTaoCuonSachCu {
    ...
    public static void showCombine(Player player) {
        ...
        text.append(quantityTrangSachCu >= 999 ? ConstFont.BOLD_BLUE : ConstFont.BOLD_RED).append("Trang sách cũ ").append(quantityTrangSachCu).append("/999\n");
        text.append(quantityBiaSach >= 1 ? ConstFont.BOLD_BLUE : ConstFont.BOLD_RED).append("Bìa sách ").append(quantityBiaSach).append("/1\n");
        text.append(quantityTrangSachCu < 999 || quantityBiaSach < 1 ? ConstFont.BOLD_RED : ConstFont.BOLD_BLUE).append("Tỉ lệ thành công: 20%\n");
        text.append(ConstFont.BOLD_RED).append("Thất bại mất 99 trang sách và 1 bìa sách");
        if (quantityTrangSachCu < 999 || quantityBiaSach < 1) {

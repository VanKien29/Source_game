...
public class NangCapSaoPhaLe {
    ...
    public static void showInfoCombine(Player player) {
        ...
        if (player.combine.itemsCombine.size() != 1) {
            Service.gI().sendDialogMessage(player, "Cần 2 Sao Pha Lê cấp 1");
            return;
        }
        //    Item hematite = null;
...
//            else 
       ...
       // text.append(ConstFont.BOLD_GREEN).append("Cần 1 Hematite\n");
        text.append(ConstFont.BOLD_GREEN).append("Cần 2 ").append(saoPhaLeC1.template.name).append("\n");
...
//            } else 
        ...
        InventoryService.gI().subQuantityItemsBag(player, saoPhaLeC1, 2);

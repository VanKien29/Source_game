...
public class NangCapKichHoatVip {
    ...
    private static final int REQUIRED_THAN_LINH = 3;
    private static final int REQUIRED_DA_THUONG = 5;
    private static final int REQUIRED_DA_VIP = 1;
    private static final int REQUIRED_THOI_VANG = 300;
    private static final int REQUIRED_XU_HORIZON = 300;
    ...
    public static void showInfoCombine(Player player) {
        ...
        String npcSay = "Nâng cấp SKH VIP sẽ đổi đồ Hủy Diệt đầu tiên thành SKH cùng món.\n"
    ...
    public static void startCombine(Player player) {
        ...
        Item newItem = createLevelSkhItem(player, data.huyDietItems.get(0));
    ...
    private static Item createLevelSkhItem(Player player, Item baseItem) {

...
public class SieuBoHung extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (plKill != null && Util.isTrue(1, 10)) {
        ...
        if (plKill != null && Util.isTrue(1, 20)) {
            ItemMap it = new ItemMap(this.zone, 15, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);
        }

...
public class BlackGoku extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (plKill != null
                && TaskService.gI().getIdTask(plKill) == ConstTask.TASK_31_0
                && Util.isTrue(1, 20)) {

            Service.gI().dropItemMap(this.zone,
                    new ItemMap(this.zone, 992, 1,
                            this.location.x,
...
//        }
        ...
        if (plKill != null) {
            if (Util.isTrue(100, 100)) {
                Item egg = InventoryService.gI().findItemBag(plKill, 1957);
                if (egg != null) {
                    Item.ItemOption killOpt = egg.getOptionById(222);
                    if (killOpt != null) {
                        killOpt.param += 1;
                    } else {
                        egg.itemOptions.add(new Item.ItemOption(222, 1));
                        killOpt = egg.getOptionById(222);
                    }

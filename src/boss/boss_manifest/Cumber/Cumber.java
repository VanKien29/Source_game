...
//            it.options.add(new Item.ItemOption(50, Util.nextInt(25, 35)));
...
//        }
        if (plKill != null) {
            if (Util.isTrue(100, 100)) {
                Item egg = InventoryService.gI().findItemBag(plKill, 1955);
                if (egg != null) {
                    Item.ItemOption killOpt = egg.getOptionById(186);
                    if (killOpt != null) {
                        killOpt.param += 1;
                    } else {
                        egg.itemOptions.add(new Item.ItemOption(186, 1));
                        killOpt = egg.getOptionById(186);
                    }

...
public class BossesData {
    ...
    // **************************************************************************
     public static final BossData DAITUONGBROLY = new BossData(
            "Đại Tướng Broly", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1589, 1590, 1591, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            100000, // dame
      ...
      public static final BossData Hatchiyac = new BossData(
            "Hatchiyac", // name
            ConstPlayer.XAYDA, // gender
    ...
    // ========================BROLY SSJ========================
    public static final BossData SSJ_1 = new BossData(
            "Broly Siêu Xayda 1", // name
            ConstPlayer.XAYDA, // gender
            new short[]{2180, 2183, 2184, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            32000, // dame
            new long[]{2000000000}, // hp
    ...
    public static final BossData SSJ_2 = new BossData(
            "Broly Siêu Xayda 2", // name
            ConstPlayer.XAYDA, // gender
            new short[]{2185, 2188, 2184, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            50000, // dame
    ...
    // ========================3  con sói========================
    public static final BossData SOI_1 = new BossData(
            "Sói Bergamo", // name
            ConstPlayer.XAYDA, // gender
    ...
    public static final BossData SOI_2 = new BossData(
            "Sói Lavender", // name
            ConstPlayer.XAYDA, // gender
            new short[]{748, 749, 750, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            50000, // dame
            new long[]{1_800_000_000}, // hp
            new int[]{92}, // map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_LIENHOAN), // skill
            new String[]{"|-1|Hê hê, cẩn thận đi",
                "|-1|Nếu đã biến thành thế này thì ta sẽ không nhùn nhặn như trước đâu"
    ...
    public static final BossData SOI_3 = new BossData(
            "Sói Basil", // name
            ConstPlayer.XAYDA, // gender
...
//                {Skill.TAI_TAO_NANG_LUONG, 7, 100000},
    ...
    public static final BossData NYASU = new BossData(
            "Mèo Nyasuuu", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1656, 1657, 1658, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            30000, //dame
            new long[]{1_000_000_000}, //hp
            new int[]{0, 7, 14}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_ANTOMIC), 
            new String[]{"|-2|Chào anh! em đứng đây từ chiều",
                "|-1|Quái lạ! Sao chúng biết rõ tung tích của bọn ta thế nhỉ?",
                "|-1|Chúng còn biết chính xác ta sẽ xuất hiện ở đây để đón đánh nữa!",
                "|-1|Chúng mày là ai từ đâu tới?Cho tao xin cái địa chỉ",
            ...
            new int[]{BossID.JESSIE, BossID.JAMES}
    );
    public static final BossData JESSIE = new BossData(
            "Nàng Jessie", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1662, 1663, 1664, 145, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            30000, //dame
    ...
    public static final BossData JAMES = new BossData(
            "Chàng James", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1659, 1660, 1661, 145, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            30000, //dame
            new long[]{500_000_000}, //hp
            new int[]{0, 7, 14}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_ANTOMIC, FULL_TDHS),
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?",
                "|-1|Ê cố lên nhóc",
                "|-1|Chán",
    ...
    public static final BossData CADIC = new BossData(
            ...
            new int[][]{
                ...
                {Skill.TAI_TAO_NANG_LUONG, 7, 10000},}, // skill
            new String[]{"|-1| ",
    ...
    public static final BossData DORAEMON = new BossData(
            "Đôrêmon", // name
            ConstPlayer.TRAI_DAT, // gender
            new short[]{790, 791, 792, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            300000, // dame
            ...
            REST_15_M,
            new int[]{BossID.XEKO, BossID.CHAIEN, BossID.XUKA, BossID.NOBITA,} // type appear
    );

...
public class BossID {
    ...
    public static final int DAITUONGBROLY = -700;
    public static final int Hatchiyac = -705;
    // ========================DOANH TRAI========================
...
public static final int Duong = -2900;
    ...
    // ========================DORAEMON========================
    public static final int DORAEMON = -369;
    public static final int NOBITA = -370;
    public static final int XUKA = -376;
    public static final int XEKO = -372;
    public static final int CHAIEN = -373;
    // ========================BROLY SSJ========================
    public static final int BROLY_SSJ = -374;
    // ========================SOI========================
    public static final int BA_CON_SOI = -375;
    ...
    public static final int JAMES = -378;
    public static final int JESSIE = -379;
    public static final int NYASU = -380;
    
    public static final int BE_NA = -346325;

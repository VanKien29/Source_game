 ...
 * @author CongHoan
 */
import HoandzManager.FileRunner;
...
import server.admin.AdminHttpServer;
...
//        new Thread((Runnable) TaiXiu.gI(), "Thread TaiXiu").start();
                    ...
                    is.setMessageHandler(Controller.gI())
                            .setSendCollect(new MessageSendCollect() {
                                ...
                                public void doSendMessage(ISession session, DataOutputStream dos, Message msg)
                                        throws Exception {
                                    byte[] data = msg.getData(); // empty catch block
                                    if (session.sentKey()) {

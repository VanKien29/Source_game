...
public class Controller implements IMessageHandler {
    ...
    private long lastTimeGK = 0;
    private long lastTimeGK1 = 0;
        ...
        try {
            ...
            switch (cmd) {
                ...
                case 6: // buy item
                    ...
                    break;
//                     case 111: // Command xử lý tất cả các tương tác Tài Xỉu từ client
//                {
//                    byte txAction = _msg.reader().readByte();
//                    switch (txAction) {
//                        case 0: // Yêu cầu thông tin thời gian
//                            TaiXiu.gI().sendTimeInfo(player);
//                            break;
//
//                        case 1: // Xử lý đặt cược
//                            TaiXiu.gI().handleTaiXiuBet(player, _msg);
//                            break;
//
//                        case 2: // Yêu cầu bảng xếp hạng (chức năng mới)
//                            TaiXiu.gI().sendRankingToPlayer(player);
//                            break;
//
...
//                    break;
//                }
//                 case 109: // Request game history
//                    byte historyType = _msg.reader().readByte();
//                    if (historyType == 0) {
//                        // Xử lý yêu cầu lịch sử thông thường
//                        TaiXiu.gI().sendHistoryToPlayer(player);
//                    } else if (historyType == 1) {
//                        // Xử lý yêu cầu soi cầu chi tiết
//                        TaiXiu.gI().sendSoiCauHistoryToPlayer(player);
//                    }
//                    break;
                case 7: // sell item
                    if (player != null && !Maintenance.isRunning) {
...
//                    if (network.server.HOANDZServer.firewallDownDataGame.containsKey(ip)) {
//                        int soLanConnect = network.server.HOANDZServer.firewallDownDataGame.get(ip).intValue();
//                        if (soLanConnect > 999) {
//                            Service.gI().sendThongBaoOK(_session,
//                                    "Bạn đã tải dữ liệu nhiều lần, đợi bảo trì rồi quay lại");
//                            return;
//                        } else {
//                            network.server.HOANDZServer.firewallDownDataGame.put(ip, soLanConnect += 1);
//                        }
//
//                    } else {

//                        network.server.HOANDZServer.firewallDownDataGame.put(ip, 1);
//                    }
                ...
                switch (cmd) {
                    ...
                    case 13:
                        ...
                        if (player != null && player.isPl()) {
                            ...
                            InventoryService.gI().sendItemBody(player); // -37: body slots
                            InventoryService.gI().sendItemBag(player);  // -36: bag (khuyến nghị)
                            // -64 my flag bag
...
//                                @Override
//                                public void run() {
//                                    Service.gI().sendMessageServer("Mọi thắc mắc về game, vui lòng nhắn cho ADMIN!");
//                                }
//                            }, 180000, 180000);
//                            timer.scheduleAtFixedRate(new java.util.TimerTask() {
//                                @Override
//                                public void run() {
//                                    Service.gI().sendMessageServer("Nếu bạn muốn hỗ trợ vấn đề nạp game, vui lòng liên hệ ADMIN");
//                                }
//                            }, 600000, 600000);
                            // Hoan đẹp trai by code
                        }
                        break;
                    default:
                        break;
                ...
                switch (command) {
                    case 16:
                        ...
                        if (_session.player != null && _session.player.nPoint != null) {
                            _session.player.nPoint.increasePoint(type, point, false);
                        }
                        break;
                    case 18:
                        ...
                        if (_session.player != null && _session.player.nPoint != null) {
                            _session.player.pet.nPoint.increasePoint(typeP, pointP, true);
                        }
                        break;
                    case 17:
...
//        Service.gI().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại: NgocRongCyper.Online");

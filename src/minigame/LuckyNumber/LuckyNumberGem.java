...
public class LuckyNumberGem {
    public static String showOneResult() {
        return !minigame.LuckyNumber.LuckyNumber.DATA_RESULT.isEmpty() ? minigame.LuckyNumber.LuckyNumber.DATA_RESULT
                .get(minigame.LuckyNumber.LuckyNumber.DATA_RESULT.size() - 1).toString().formatted("%02d") : "";
    }
